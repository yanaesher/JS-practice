...
Wallet.prototype.withdraw = function (amount) {
  ...
  if (this._dailyTotalAllowance + amount > this._dailyAllowance) {
    console.log(`Your limit for this day: ${this._dailyAllowance}`);
    return 0;
  }
  this._dayTotalAllowance += amount;
  this._cash -= amount;
  return amount;
};
...
Wallet.prototype.setDailyAllowance = function (newAllowance) {
  ...
  console.log(`Your new allowance ${this._dailyAllowance}`);
};
